...
public class TextScreen extends Form implements CommandListener {
    ...
    private static final Command CMD_EDIT =
            new Command("Edit Text", Command.ITEM, COMMAND_PRIORITY);
     ...
     */
    TextScreen(HelloWorldPlusMIDlet midlet, String message) {
     ...
     * <p>
     * The CMD_EDIT command initiates the launch of the TextEditor screen. The
     * method handles this command by calling the parent method textEditorRequested().
     *
